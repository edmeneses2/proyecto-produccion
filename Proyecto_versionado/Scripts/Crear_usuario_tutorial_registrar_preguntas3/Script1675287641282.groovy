...
'ttt'
Mobile.tap(findTestObject('Object Repository/Agregar_contacto/android.widget.ImageButton (1)'), 0)

Mobile.tap(findTestObject('Object Repository/Home/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('null'), 0)

Mobile.tap(findTestObject('btn_seleccioncontacto'), 0)

Mobile.tap(findTestObject('bntok_perfilcontacto'), 0)

Mobile.tap(findTestObject('null'), 0)

Mobile.setText(findTestObject('null'), 'prueba ', 
    0)
...
Mobile.setText(findTestObject('null'), 'mensajes de prueba de nn chat', 
    0)

Mobile.tap(findTestObject('null'), 0)

Mobile.tapAndHold(findTestObject('null'), 8, 0)

Mobile.tapAndHold(findTestObject('null'), 8, 0)

Mobile.tap(findTestObject('null'), 0)

Mobile.setText(findTestObject('null'), 'Prueba de mensaje entregado', 
    0)
...
Mobile.tapAndHold(findTestObject(''), 8, 0)
